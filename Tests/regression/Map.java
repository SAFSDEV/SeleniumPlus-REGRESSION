...
public final class Map implements RuntimeDataAware {
    ...
    public static class FormsMain {
        ...
        /** "MultiListBox" Component in "FormsMain". */
        public static final Component MultiListBox = new Component(FormsMain, "MultiListBox");
        ...
        /** "ChoiceBox" Component in "FormsMain". */
        public static final Component ChoiceBox = new Component(FormsMain, "ChoiceBox");
    ...
    /** "DotNetApp" Component and its children. */
    public static class DotNetApp {

        // No use for a default constructor.
        private DotNetApp(){}

        /** "DotNetApp" Window Component itself. */
        public static final Component DotNetApp = new Component("DotNetApp");

        /** "TableControl" Component in "DotNetApp". */
        public static final Component TableControl = new Component(DotNetApp, "TableControl");

        /** "DataView" Component in "DotNetApp". */
        public static final Component DataView = new Component(DotNetApp, "DataView");
    }
